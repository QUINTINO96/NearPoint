...
import com.nearpoint.Application;
...
public class EmployeeControllerIntegrationTest {
	...
	public void testCreateEmployee() {
		...
		ResponseEntity<Post> postResponse = restTemplate.postForEntity(getRootUrl(), employee, Post.class);
	...
	public void testGetEmployeeById() {
		Post employee = restTemplate.getForObject(getRootUrl() + "/1", Post.class);
